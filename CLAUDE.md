...
コピーを書く前に必ず問う：
- **この商品・このコレクションを使っている人は、どんな状態にあるか**（スペックではなく感覚・体験として答える）
- その体験全体を一つのイメージで掴めるか（個別FACTの翻訳ではなく、体験全体の掴み取り）
- **キャッチコピーと商品名の役割分担を設計する**：キャッチで感情を担い、商品名・シリーズ名で機能を担保する構造が成立するか。どちらかが機能を担保するなら、コピーは感情だけに集中できる
