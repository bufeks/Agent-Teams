...
class CreativeTeam:
    ...
    ECD_CD_BRIEF_SYSTEM = (
        ...
        "【戦略方向性マップのルール】\n"
        "・方向性は最低3案出す\n"
        "・うち1案は『ブリーフが期待している方向とは別の問い立て』から出発すること\n"
        "・似た方向性の並列は不可。各案は構造的に異なること\n\n"
        "【各方向性に付けるセット】\n"
        "・タイトル：方向性を表す一言\n"
    ...
    ECD_FINAL_SYSTEM = (
        ...
        "【最終ディレクションに含めるもの】\n"
        "■ コンセプトの最終判定（何が強く、何が弱いか）\n"
        "■ このキャンペーンが日本市場と世界に対して何を変えるか\n"
        "■ Creative BriefのTBD欄（campaign_concept / campaign_tagline / key_visual / catch_copy）の確定\n"
